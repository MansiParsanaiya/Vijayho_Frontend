...
">
  ...
  ">
    ...
    <tr style="height: 20px !important">
        ...
        <td style="border-right: 0.1px solid black !important" colspan="2">{PRODUCT_CODE}</td>
        <!-- <td style="border-right: 0.1px solid black !important">{PRODUCT_NAME}</td> -->
        <td style="border-right: 0.1px solid black !important" colspan="2">{DELIVERY} <br> 
        </td>

        <td style="float: right;">
            <div style="float: left; font-family: NotoSansGujarati-Regular !important;">₹ </div> {RENT} <tr style="height: 20px !important;">
        <td style="border-right: 0.1px solid black !important" align="center">
